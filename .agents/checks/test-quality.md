...
- Use `@testing-library/vue` with `@testing-library/user-event` for component testing (an ESLint rule bans `@vue/test-utils` in new tests); `@pinia/testing` (`createTestingPinia`) for store tests
