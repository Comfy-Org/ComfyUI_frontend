...
describe('useTransformState', () => {
  ...
  describe('syncWithCanvas', () => {
    it('should sync camera state with canvas transform', () => {
      ...
      syncWithCanvas(mockCanvas as unknown as LGraphCanvas)
    ...
    it('should handle null canvas gracefully', () => {
      ...
      syncWithCanvas(null as unknown as LGraphCanvas)
    ...
    it('should handle canvas without ds property', () => {
      ...
      syncWithCanvas(canvasWithoutDs as unknown as LGraphCanvas)
  ...
  describe('coordinate conversions', () => {
    beforeEach(() => {
      ...
      mockCanvas.ds.offset = [100, 50]
      mockCanvas.ds.scale = 2
      transformState.syncWithCanvas(mockCanvas as unknown as LGraphCanvas)
    })
