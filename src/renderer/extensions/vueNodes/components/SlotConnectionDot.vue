...
const slotClass = computed(() =>
  cn(
    ...
    props.multi
      ? 'h-5 w-2'
      : 'size-2 cursor-crosshair group-hover/slot:scale-125 group-hover/slot:[--node-component-slot-dot-outline-opacity-mult:5] group-[.lg-slot--snap-target]/slot:[--node-component-slot-dot-outline-opacity-mult:5] group-[.lg-slot--snap-target]/slot:scale-125'
  )
)
</script>
