...
const slotClass = computed(() =>
  cn(
    ...
    props.multi
      ? 'w-3 h-6'
      : 'size-3 cursor-crosshair group-hover/slot:[--node-component-slot-dot-outline-opacity-mult:5] group-hover/slot:scale-125 group-[.lg-slot--snap-target]/slot:[--node-component-slot-dot-outline-opacity-mult:5] group-[.lg-slot--snap-target]/slot:scale-125'
  )
)
</script>
