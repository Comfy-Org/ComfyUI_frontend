<template>
  ...
  >
    ...
    <div
      ref="imageWrapperEl"
      class="min-h-0 flex-1 flex w-full overflow-hidden rounded-[5px] bg-transparent relative"
      tabindex="0"
      role="img"
    ...
    >
      ...
      <div
        v-if="imageError"
        role="alert"
        class="flex flex-1 self-center size-full flex-col items-center justify-around text-center text-base-foreground py-8"
      >
        <i
