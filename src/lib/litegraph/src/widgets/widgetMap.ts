...
import type { ColorWidget } from './ColorWidget'
import type { ComboWidget } from './ComboWidget'
import type { FileUploadWidget } from './FileUploadWidget'
import type { GalleriaWidget } from './GalleriaWidget'
import type { ImageCompareWidget } from './ImageCompareWidget'
import type { KnobWidget } from './KnobWidget'
import type { LegacyWidget } from './LegacyWidget'
import type { MarkdownWidget } from './MarkdownWidget'
import type { MultiSelectWidget } from './MultiSelectWidget'
import type { NumberWidget } from './NumberWidget'
import type { SelectButtonWidget } from './SelectButtonWidget'
...
import type { TreeSelectWidget } from './TreeSelectWidget'
