...
export function toConcreteWidget<TWidget extends IWidget | IBaseWidget>(
  ...
  case "image": return toClass(ImageWidget, narrowedWidget, node)
...
export function isFileUploadWidget(widget: IBaseWidget): widget is IFileUploadWidget {
...
export function isMarkdownWidget(widget: IBaseWidget): widget is IMarkdownWidget {
...
export function isTreeSelectWidget(widget: IBaseWidget): widget is ITreeSelectWidget {
  return widget.type === "treeselect"
}

/** Type guard: Narrow **from {@link IBaseWidget}** to {@link IMultiSelectWidget}. */
export function isMultiSelectWidget(widget: IBaseWidget): widget is IMultiSelectWidget {
...
export function isGalleriaWidget(widget: IBaseWidget): widget is IGalleriaWidget {
  return widget.type === "galleria"
}

/** Type guard: Narrow **from {@link IBaseWidget}** to {@link IImageCompareWidget}. */
export function isImageCompareWidget(widget: IBaseWidget): widget is IImageCompareWidget {
  return widget.type === "imagecompare"
}

/** Type guard: Narrow **from {@link IBaseWidget}** to {@link ISelectButtonWidget}. */
export function isSelectButtonWidget(widget: IBaseWidget): widget is ISelectButtonWidget {
  return widget.type === "selectbutton"
}

/** Type guard: Narrow **from {@link IBaseWidget}** to {@link ITextareaWidget}. */
export function isTextareaWidget(widget: IBaseWidget): widget is ITextareaWidget {
