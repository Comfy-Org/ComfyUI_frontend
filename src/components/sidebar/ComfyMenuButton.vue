...
const translatedItems = computed(() => {
  ...
  let helpItem: MenuItemType | undefined
...
const isZoomCommand = (item: MenuItemType) => {
  return (
...
const handleZoomMouseDown = (item: MenuItemType, event: MouseEvent) => {
...
const handleItemClick = (item: MenuItemType, event: MouseEvent) => {
...
const hasActiveStateSiblings = (item: MenuItemType): boolean => {
