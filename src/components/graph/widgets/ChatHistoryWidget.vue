    ...
    <div v-for="(item, i) in parsedHistory" :key="i" class="mb-4">
      ...
      >
        <div class="mb-1 flex justify-end">
          <div
            class="max-w-[80%] rounded-xl bg-node-component-surface-hovered px-4 py-1 text-right"
          >
        ...
        <div class="mr-1 mb-2 flex justify-end">
          ...
          <Button
            ...
            text
            rounded
            class="h-4! w-4! p-1! text-text-secondary transition hover:text-text-primary"
