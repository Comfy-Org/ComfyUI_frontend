<template>
  <div class="flex flex-col gap-3 pb-3">
    ...
    <div class="flex flex-col gap-3 pb-3">
      ...
      >
        <div
          class="imageCanvas_sidePanelBrushShapeCircle hover:bg-comfy-menu-bg"
          :class="
            cn(
        ...
        <div
          class="imageCanvas_sidePanelBrushShapeSquare hover:bg-comfy-menu-bg"
          :class="
            cn(
