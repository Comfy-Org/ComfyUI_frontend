    ...
    en: {
      ...
      templateWorkflows: {
        ...
        detail: {
          ...
          downloadModelNamed: 'Download {model}',
          getItManually: 'Get it manually',
          openWithoutDownloading: 'Open without downloading',
          downloadStarterPack: 'Download starter pack',
          downloadRemaining: '{total} left',
          modelTypes: {
            model: 'Model',
