    ...
    >
      ...
      >
        ...
        <div
          ...
          :aria-busy="true"
          :aria-label="t('videoEdit.loadingFilmstrip')"
        >
          <Skeleton
...
const { isScrubDragging, startScrubDrag } = useTimelineScrub(playheadFrame, {
  trackRef,
  frameMax,
  scrubMin: toRef(() => (trimEnabled ? startFrame.value : 0)),
  scrubMax: toRef(() => (trimEnabled ? endFrame.value : frameMax.value)),
