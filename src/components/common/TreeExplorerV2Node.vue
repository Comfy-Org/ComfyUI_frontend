  ...
  >
    ...
    >
      ...
      <button
        :class="
          cn(
            'hover:text-foreground flex size-5 shrink-0 cursor-pointer items-center justify-center rounded-sm border-none bg-transparent text-muted-foreground',
...
const ROW_CLASS =
  'group/tree-node flex w-[calc(100%-var(--spacing)*4)] min-w-0 cursor-pointer select-none items-center gap-3 overflow-hidden py-2 outline-none hover:bg-comfy-input mx-2 rounded'
