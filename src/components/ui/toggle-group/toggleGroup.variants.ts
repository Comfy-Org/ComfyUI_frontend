...
export const toggleGroupItemVariants = cva({
  base: [
    ...
    'data-[state=on]:bg-secondary-background-selected data-[state=on]:text-base-foreground'
  ],
  variants: {
    variant: {
      default:
        'bg-transparent text-muted-foreground hover:bg-secondary-background-selected/50',
      outline:
