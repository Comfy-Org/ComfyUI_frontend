...
<template>
  ...
  >
    ...
    />
    <ContextMenuSub v-else-if="toValue(item.visible) !== false && item.items">
      <ContextMenuSubTrigger
      ...
      <ContextMenuPortal>
        <ContextMenuSubContent :class="menuContentClass" :side-offset="2">
          <ContextMenuItems :items="item.items" />
        </ContextMenuSubContent>
      </ContextMenuPortal>
    </ContextMenuSub>
    <ContextMenuItem
