...
<template>
  ...
  >
    <SliderTrack
      ...
      :class="
        cn(
          'relative grow overflow-hidden rounded-full bg-border-subtle',
    ...
    >
      <SliderRange
        ...
        :class="
          cn(
            'absolute bg-base-foreground data-[orientation=horizontal]:h-full data-[orientation=vertical]:w-full',
            props.rangeClass
          )
        "
      />
    ...
    <SliderThumb
      ...
      :class="
        cn(
          'block size-3.5 shrink-0 rounded-full bg-base-foreground shadow-sm ring-border-default transition-[color,box-shadow]',
          'cursor-grab',
