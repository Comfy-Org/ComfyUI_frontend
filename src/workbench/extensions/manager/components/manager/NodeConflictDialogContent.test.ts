...
describe(
  NodeConflictDialogContent.__name ?? 'NodeConflictDialogContent',
  () => {
    ...
    describe('rendering', () => {
      it('should render without conflicts', () => {
        ...
        expect(
          wrapper.find('[class*="Import Failed Extensions"]').exists()
        ).toBe(false)
      })
    ...
    describe('panel interactions', () => {
      ...
      it('should toggle import failed panel', async () => {
        ...
        expect(
          wrapper
            .find('[data-testid="conflict-dialog-panel-expanded"]')
            .exists()
        ).toBe(false)
    ...
    describe('empty states', () => {
      ...
      it('should handle conflicts without import_failed', () => {
        ...
        mockConflictData.value = [
          mockConflictResults[0],
          mockConflictResults[1]
        ]
        const wrapper = createWrapper()
