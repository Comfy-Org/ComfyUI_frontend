<template>
  <Card
    class="shadow-elevation-3 inline-flex h-full w-full flex-col items-start justify-between overflow-hidden rounded-lg bg-modal-card-surface transition-all duration-200"
    :class="{
