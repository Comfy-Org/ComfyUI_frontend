...
The In-App Agent side panel, built as a manager-pattern workbench extension. The panel
lives entirely in this subtree and renders through a host `vue` sidebar tab
