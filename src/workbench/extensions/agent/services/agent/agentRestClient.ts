...
export interface PostMessageInput {
   ...
   *
   * TEMPORARY: current_tab_unbound isn't in the generated ingest-types yet
   * (cloud#10068) - the outbound body here stays a plain Record rather than
   * the generated AgentPostMessageRequest until that lands and this package
   * is regenerated.
   */
