/**
 * Read-time schema-version gate.
 *
 * Bump `SCHEMA_VERSION` when an old reader would mis-project a new doc;
 * fail closed on an unreadable schema.
 *
 ...
 * reader — whatever keys still parsed would render, silently and wrongly.
 *
