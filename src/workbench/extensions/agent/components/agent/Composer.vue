    ...
    >
      ...
      >
        <span
          ...
          class="group inline-flex max-w-full items-center rounded-sm bg-primary-background/30 px-1 py-0.5 text-xs/[15px] font-normal text-primary-background-hover ring-1 ring-primary-background/30 ring-inset"
        >
