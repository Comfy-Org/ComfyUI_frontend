...
import { PUBLIC_ROUTE_PATHS as PUBLIC_ROUTE_PATH_LIST } from '@/platform/auth/session/publicRoutes'
...
if (isCloud) {
  ...
  const PUBLIC_ROUTE_PATHS = new Set<string>(PUBLIC_ROUTE_PATH_LIST)
