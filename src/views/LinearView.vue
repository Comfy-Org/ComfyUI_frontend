  ...
  <div v-else class="absolute w-full h-full">
    ...
    >
      <SplitterPanel
        ...
        :class="
          cn(
            'outline-none arrange-panel overflow-hidden',
            showLeftBuilder ? 'bg-comfy-menu-bg min-w-78' : 'min-w-78'
          )
        "
      >
        ...
        <div
          ...
          class="h-full w-full overflow-x-hidden border-border-subtle border-r"
        >
      ...
      <SplitterPanel
        ...
        :class="
          cn(
            'outline-none arrange-panel overflow-hidden',
            showRightBuilder ? 'bg-comfy-menu-bg min-w-78' : 'min-w-78'
          )
        "
      >
        ...
        <div
          v-else-if="activeTab"
          class="h-full w-full overflow-x-hidden border-border-subtle border-l"
        >
          <ExtensionSlot :extension="activeTab" />
        </div>
      </SplitterPanel>
