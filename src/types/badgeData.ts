 ...
 * (settings, node definition, palette, pricing, connectivity). Core rows
 * carry raw source text plus which projection part they are, so each
 * renderer applies its own ordering, joining, and trimming. Extension badges are
