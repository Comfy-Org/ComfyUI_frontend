...
describe('nodeIdentification', () => {
  describe('NodeLocatorId', () => {
    ...
    describe('isNodeLocatorId', () => {
      ...
      it('should return false for invalid formats', () => {
        expect(isNodeLocatorId(`${validUuid}:node_1`)).toBe(false) // Non-numeric local id
        expect(isNodeLocatorId('node_1')).toBe(false) // Non-numeric local id
    ...
    describe('parseNodeLocatorId', () => {
      ...
      it('should return null for non-numeric local node IDs', () => {
        expect(parseNodeLocatorId(`${validUuid}:node_1`)).toBeNull()
        expect(parseNodeLocatorId('node_1')).toBeNull()
      })
  ...
  describe('NodeExecutionId', () => {
    describe('isNodeExecutionId', () => {
      ...
      it('should return false for non-execution IDs', () => {
        ...
        expect(isNodeExecutionId('node_1:node_2')).toBe(false) // Non-numeric segments
    ...
    describe('parseNodeExecutionId', () => {
      ...
      it('should return null for non-execution IDs', () => {
        ...
        expect(parseNodeExecutionId('node_1:node_2')).toBeNull() // Non-numeric
        expect(parseNodeExecutionId('123:node_2:456')).toBeNull() // Non-numeric
      })
    })
  ...
  describe('Integration tests', () => {
    ...
    it('should round-trip NodeExecutionId correctly', () => {
      const nodeIds: NodeId[] = [asNodeId(123), asNodeId(789), asNodeId(456)]
