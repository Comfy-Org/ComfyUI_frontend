...
import { useImageCropWidget } from '@/renderer/extensions/vueNodes/widgets/composables/useImageCropWidget'
...
export const ComfyWidgets = {
  ...
  IMAGECROP: transformWidgetConstructorV2ToV1(useImageCropWidget()),
