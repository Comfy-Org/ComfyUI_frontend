import type { AvifIinfBox, AvifIlocBox, ComfyMetadata, ComfyMetadataTags, IsobmffBoxContentRange } from '@/types/metadataTypes'
import { AvifInfeBox } from '@/types/metadataTypes'
