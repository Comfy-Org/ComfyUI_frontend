...
const prodDefaultGraph: ComfyWorkflowJSON = {
  ...
  links: [
    [72, asNodeId(66), 0, asNodeId(69), 0, 'MODEL'],
    [73, asNodeId(70), 0, asNodeId(65), 0, 'LATENT'],
    [74, asNodeId(63), 0, asNodeId(65), 1, 'VAE'],
    [75, asNodeId(69), 0, asNodeId(70), 0, 'MODEL'],
    [76, asNodeId(67), 0, asNodeId(70), 1, 'CONDITIONING'],
    [78, asNodeId(68), 0, asNodeId(70), 3, 'LATENT'],
    [79, asNodeId(62), 0, asNodeId(67), 0, 'CLIP'],
    [80, asNodeId(65), 0, asNodeId(9), 0, 'IMAGE'],
    [81, asNodeId(62), 0, asNodeId(71), 0, 'CLIP'],
    [82, asNodeId(71), 0, asNodeId(70), 2, 'CONDITIONING']
  ],
  groups: [],
  config: {},
  extra: {
