<template>
  <div class="flex flex-col gap-6 p-6">
    ...
    <PublishRequirementsSection ref="requirementsRef" />
    ...
    <div class="flex flex-col gap-2">
      ...
      >
        <label
          ...
          :class="
            cn(
              'relative flex cursor-pointer items-center gap-2 overflow-hidden rounded-lg border border-border-default px-3 py-2 text-sm transition-colors',
...
import PublishRequirementsSection from './PublishRequirementsSection.vue'
...
const requirementsRef =
  ref<ComponentPublicInstance<{ autoDetectRequirements: () => void }>>()
...
function onWorkflowSelected(path: string | undefined) {
  ...
  requirementsRef.value?.autoDetectRequirements()
}
