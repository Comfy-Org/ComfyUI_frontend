...
describe('workspaceApi', () => {
  ...
  describe('billing', () => {
    ...
    it.for([undefined, 'sub_test_1'])(
      'getChurnkeyAuth() retains optional test admission %s',
      async (testSubscriptionId) => {
        const data = {
          customer_id: 'cus_test_1',
          auth_hash: 'hash-1',
          mode: 'test',
          test_discount_subscription_id: testSubscriptionId
        }
        mockAxiosInstance.get.mockResolvedValue({ data })
    ...
    it.for([{ auth_hash: '' }, { test_discount_subscription_id: '' }])(
