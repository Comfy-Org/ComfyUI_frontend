...
const meta: Meta<typeof AssetFilterBar> = {
  ...
  decorators: [
    () => ({
      template: `
        <div class="min-h-screen bg-interface-panel-surface">
          <div class="bg-modal-background border-b border-interface-stroke">
            <story />
          </div>
          ...
          <button
            ...
            :class="[
              ...
              selectedCategory === 'all'
                ...
                : 'bg-button-surface border-interface-stroke'
            ]"
          >
