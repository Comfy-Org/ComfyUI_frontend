          ...
          <template v-if="query.trim()">
            <template v-for="section in searchSections" :key="section.facet">
              ...
              <DropdownMenuCheckboxItem
                ...
                :class="rowClass"
                @select.prevent="select(section.facet, row.value)"
              >
                  ...
                  >
                    ...
                    <div class="p-1">
                      <DropdownMenuCheckboxItem
                        ...
                        :class="rowClass"
                        @select.prevent="select(cat, opt.value)"
                      >
  ...
  switch (cat) {
    ...
    case 'media':
      return [
        ...
        { value: 'video', text: t('sideToolbar.mediaAssets.filterVideo') },
        { value: 'audio', text: t('sideToolbar.mediaAssets.filterAudio') },
        { value: '3d', text: t('sideToolbar.mediaAssets.filter3D') },
        { value: 'text', text: t('sideToolbar.mediaAssets.filterText') }
      ]
    case 'date':
      return [
        { value: '', text: t('sideToolbar.mediaAssets.dateAll') },
        { value: 'today', text: t('sideToolbar.mediaAssets.dateToday') },
        { value: 'week', text: t('sideToolbar.mediaAssets.datePastWeek') },
        { value: 'month', text: t('sideToolbar.mediaAssets.datePastMonth') },
        { value: 'year', text: t('sideToolbar.mediaAssets.dateThisYear') }
      ]
  }
}
