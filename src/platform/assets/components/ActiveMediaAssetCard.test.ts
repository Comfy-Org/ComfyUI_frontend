...
describe('ActiveJobCard', () => {
  ...
  it('displays percentage and progress bar when job is running', () => {
    ...
    // oxlint-disable-next-line testing-library/no-container, testing-library/no-node-access -- progress bar has no ARIA role in happy-dom
  ...
  it('shows spinner for pending state', () => {
    ...
    // oxlint-disable-next-line testing-library/no-container, testing-library/no-node-access -- spinner icon has no ARIA role in happy-dom
  ...
  it('shows error icon for failed state', () => {
    ...
    // oxlint-disable-next-line testing-library/no-container, testing-library/no-node-access -- error icon has no ARIA role in happy-dom
