...
import type { ComfyNodeDef as ComfyNodeDefV1, InputSpec as InputSpecV1 } from '@/schemas/nodeDefSchema'
import { getComboSpecComboOptions, isComboInputSpec, isComboInputSpecV1 } from '@/schemas/nodeDefSchema'
