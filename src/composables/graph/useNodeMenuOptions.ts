...
export function useNodeMenuOptions() {
  ...
  function getAdjustSizeOption(): MenuOption {
    return {
  ...
  function getRunBranchOption(): MenuOption {
    return {
  ...
  function getNodeInfoOption(openNodeInfo: () => boolean): MenuOption {
    return {
