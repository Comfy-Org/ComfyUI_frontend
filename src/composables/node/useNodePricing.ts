...
const apiNodeCosts: Record<string, { displayPrice: string | PricingFunction }> =
  {
    ...
    PikaImageToVideoNode2_2: {
      displayPrice: (node: LGraphNode): string => {
        ...
        if (!durationWidget || !resolutionWidget) {
          return formatCreditsRangeLabel(0.2, 1.0, {
        ...
        if (duration.includes('5')) {
          if (resolution.includes('1080p')) return formatCreditsLabel(0.45)
          if (resolution.includes('720p')) return formatCreditsLabel(0.2)
        } else if (duration.includes('10')) {
          if (resolution.includes('1080p')) return formatCreditsLabel(1.0)
          if (resolution.includes('720p')) return formatCreditsLabel(0.6)
        }

        return formatCreditsLabel(0.2)
      }
    },
    PikaScenesV2_2: {
      displayPrice: (node: LGraphNode): string => {
        ...
        if (duration.includes('5')) {
          if (resolution.includes('720p')) return formatCreditsLabel(0.3)
          if (resolution.includes('1080p')) return formatCreditsLabel(0.5)
        } else if (duration.includes('10')) {
          if (resolution.includes('720p')) return formatCreditsLabel(0.4)
          if (resolution.includes('1080p')) return formatCreditsLabel(1.5)
        }

        return formatCreditsLabel(0.3)
      }
    },
    PikaStartEndFrameNode2_2: {
      displayPrice: (node: LGraphNode): string => {
        ...
        if (duration.includes('5')) {
          if (resolution.includes('720p')) return formatCreditsLabel(0.2)
          if (resolution.includes('1080p')) return formatCreditsLabel(0.3)
        } else if (duration.includes('10')) {
          if (resolution.includes('720p')) return formatCreditsLabel(0.25)
          if (resolution.includes('1080p')) return formatCreditsLabel(1.0)
        }
    ...
    PikaTextToVideoNode2_2: {
      displayPrice: (node: LGraphNode): string => {
        ...
        if (!durationWidget || !resolutionWidget) {
          return formatCreditsRangeLabel(0.2, 1.5, {
            note: '(varies with duration & resolution)'
          })
        }
    ...
    Pikaffects: {
      displayPrice: formatCreditsLabel(0.45)
    },
    Pikaswaps: {
      displayPrice: formatCreditsLabel(0.3)
    },
    ...
    TripoTextToModelNode: {
      displayPrice: (node: LGraphNode): string => {
        ...
        if (!quadWidget || !styleWidget || !textureWidget)
          return formatCreditsRangeLabel(0.1, 0.4, {
        ...
        if (style.includes('none')) {
          if (!quad) {
            if (!texture) return formatCreditsLabel(0.1)
            else return formatCreditsLabel(0.15)
          } else {
            if (textureQuality.includes('detailed')) {
              if (!texture) return formatCreditsLabel(0.3)
              else return formatCreditsLabel(0.35)
            } else {
              if (!texture) return formatCreditsLabel(0.2)
              else return formatCreditsLabel(0.25)
            }
          }
        } else {
          // any style
          if (!quad) {
            if (!texture) return formatCreditsLabel(0.15)
            else return formatCreditsLabel(0.2)
          } else {
            if (textureQuality.includes('detailed')) {
              if (!texture) return formatCreditsLabel(0.35)
              else return formatCreditsLabel(0.4)
            } else {
              if (!texture) return formatCreditsLabel(0.25)
              else return formatCreditsLabel(0.3)
            }
          }
        }
      }
    ...
    TripoImageToModelNode: {
      displayPrice: (node: LGraphNode): string => {
        ...
        if (!quadWidget || !styleWidget || !textureWidget)
          return formatCreditsRangeLabel(0.2, 0.5, {
            note: '(varies with quad, style, texture & quality)'
          })
        ...
        if (style.includes('none')) {
          if (!quad) {
            ...
            if (textureQuality.includes('detailed')) {
              if (!texture) return formatCreditsLabel(0.4)
              else return formatCreditsLabel(0.45)
            } else {
              if (!texture) return formatCreditsLabel(0.3)
              else return formatCreditsLabel(0.35)
            }
          ...
          if (!quad) {
            ...
            if (textureQuality.includes('detailed')) {
              if (!texture) return formatCreditsLabel(0.45)
              else return formatCreditsLabel(0.5)
            } else {
              if (!texture) return formatCreditsLabel(0.35)
              else return formatCreditsLabel(0.4)
            }
