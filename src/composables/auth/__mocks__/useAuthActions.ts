...
const actions = {
  ...
  sendPasswordReset: vi.fn<AuthActions['sendPasswordReset']>(async () => true),
  purchaseCredits: vi.fn<AuthActions['purchaseCredits']>(async () => undefined),
  ...
  signInWithEmail: vi.fn<AuthActions['signInWithEmail']>(async () => undefined),
  signUpWithEmail: vi.fn<AuthActions['signUpWithEmail']>(async () => undefined),
