...
// ==========================================================================
// 13. Agent-submitted job workflow open (PM-1150 regression)
// ==========================================================================

// PM-1150: real job 33a723f2-bf1f-4faf-9c42-1b83e2185601's exact detail shape.
// comfy-cli's `run` command (used by the in-app agent's backend service) never
// populates `extra_data.extra_pnginfo.workflow` for any invocation — only the
...
const PM_1150_JOB: RawJobListItem = createMockJob({
  id: PM_1150_JOB_ID,
  create_time: 5000,
  execution_start_time: 5000,
  execution_end_time: 5040,
  preview_output: {
...
const PM_1150_JOB_DETAIL: JobDetail = {
  ...PM_1150_JOB,
  outputs: {
    '7': {
      images: [
  ...
  // No `extra_data` at all — agent-submitted jobs never embed the
  // editor-format graph. This is the root cause behind PM-1150.
  workflow: {
