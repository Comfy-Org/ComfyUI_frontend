...
// These tests verify that node outputs survive workflow tab switches.
// They are skipped because the ChangeTracker store/restore cycle for
// node outputs does not reliably work in CI's mock backend environment
// (execution produces correct values but outputs are lost after tab switch).
// The underlying nodeOutputStore logic is fully covered by unit tests in
