...
test.describe('Agent conversation replay', { tag: '@cloud' }, () => {
  ...
  // The two eval-suite cases, recorded on the local agent (they replace the
  // synthesized PoC fixtures). The recorded prompt is the eval prompt behind
  // the tab switch the replay binds on.
  test.describe('recorded agent-workflow-editing-05', () => {
  ...
  test.describe('recorded agent-l4-zimage-string-node-prompt', () => {
