...
- Code references are as of `main` @ `5782b78ab7` (2026-08-19).
- Numbered 0018: 0016 is claimed by two in-flight branches (renderer LOD,
  billing-rail routing) and 0017 is left for whichever of them renumbers.
