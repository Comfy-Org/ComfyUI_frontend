...
class model permanent when ADR 0008 intends to separate state from behavior.
...
persistence and reattachment questions settled by ADR 0008. It is not required
...
from ADR 0008 rather than changing widget identity as part of the behavior
migration.

## Notes

This ADR narrows the widget portion of
[ADR 0008](0008-entity-component-system.md). It follows
[ADR 0020](0020-bound-renderer-reactivity.md) by keeping compatibility work at
