# ADR-WIDGET-PRESENTATION-0028: Separate Widget Semantic Type from Renderer Key
...
[ADR-ECS-0008](ECS-0008-entity-component-system.md) defines
...
- `kind` alongside a deprecated `type` reads as a distinction without a stated
  ...
  [ADR-ECS-0008](ECS-0008-entity-component-system.md) already assigns to `WidgetId`.
...
- Extensions that supply unregistered plain-object widgets gain nothing from
  this ADR until ADR-ECS-WIDGETS-0023's adapter registry lands.
...
- [ADR-ECS-0008](ECS-0008-entity-component-system.md) defines widget identity and the
  dedicated-store authority this proposal refines.
- [ADR-ECS-WIDGETS-0023](ECS-WIDGETS-0023-widget-entities-with-a-legacy-layer.md) defines the
  compatibility boundary for extension-supplied widget objects that this ADR
  depends on for unregistered plain objects.
- [ADR-CRDT-LAYOUT-0003](CRDT-LAYOUT-0003-crdt-layout-intent-and-local-measurement.md) defines the longer-term command
