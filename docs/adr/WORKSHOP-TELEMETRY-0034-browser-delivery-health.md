...
Identified account and authentication refusals are excluded from service health using existing Router refusal metadata. Missing endpoints, storage upload failures and unclassified unavailability remain service failures.
