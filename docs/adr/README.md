...
| [CRDT-PENDING-0030](CRDT-PENDING-0030-pending-op-reverts-undo-optimistic-canvas-state.md)                        | Revert rejected optimistic node additions                                          | Proposed   | 2026-09-19 |
...
| [CRDT-RECONCILE-0035](CRDT-RECONCILE-0035-local-only-state-survives-authoritative-reconcile.md)                  | Local-Only State Survives Authoritative Reconcile                                  | Proposed   | 2026-09-19 |
