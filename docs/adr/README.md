...
| [CRDT-WIDGETS-0036](CRDT-WIDGETS-0036-agent-widget-writes-run-live-widget-effects.md)                            | Agent Widget Writes Run the Live Widget's Effects                                  | Proposed   | 2026-09-19 |
