...
| [WIDGET-PRESENTATION-0028](WIDGET-PRESENTATION-0028-separate-widget-semantic-type-from-renderer-key.md)          | Separate Widget Semantic Type from Renderer Key                                    | Proposed | 2026-08-24 |
