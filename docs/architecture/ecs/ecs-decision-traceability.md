...
[ADR-ECS-0008](../../adr/ECS-0008-entity-component-system.md). The ADRs remain the
...
- Within this repository, Yjs supplies mergeable layout state and
  ...
  transport. ADR-CRDT-LAYOUT-0003's amendment records removal of those unused local seams.
...
- [ADR-CRDT-LAYOUT-0003: Centralized Layout Management with CRDT](../../adr/CRDT-LAYOUT-0003-crdt-layout-intent-and-local-measurement.md)
- [ADR-ECS-0008: Entity Component System](../../adr/ECS-0008-entity-component-system.md)
