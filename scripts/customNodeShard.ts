...
// regression spec's three self-checks, and the legacy widget registration
// regression. The all-nodes TIERS are counted separately because they now
// register only when the slice contains a pack that asks for them.
