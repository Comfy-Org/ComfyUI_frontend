...
// manifest-coverage test, connectivity (three), coreSmoke (two), the
// regression spec's pack-startup extension-import test plus its three
// self-checks, and the legacy widget registration regression. The all-nodes
// TIERS are counted separately because they now register only when the slice
