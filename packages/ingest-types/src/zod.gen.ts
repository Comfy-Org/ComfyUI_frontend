...
export const zResolveSecretByCapabilityData = z.object({
  body: zResolveSecretByCapabilityRequest,
  path: z.never().optional(),
  query: z.never().optional()
})
...
export const zGetByokEntitlementSnapshotData = z.object({
  body: z.never().optional(),
  path: z.never().optional(),
  query: z.never().optional()
})
...
export const zCheckProviderPolicyData = z.object({
  body: zProviderPolicyCheckRequest,
  path: z.never().optional(),
  query: z.never().optional()
})
