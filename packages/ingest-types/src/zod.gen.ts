...
export const zAgentLlmAdmitData = z.object({
  body: z.object({
...
export const zCreateTopupCheckoutData = z.object({
  body: zCreateTopupCheckoutRequest,
  path: z.never().optional(),
  query: z.never().optional()
})
...
export const zSetGlobalSettingData = z.object({
  body: zGlobalSettingValue,
  path: z.never().optional(),
  query: z.never().optional()
})
...
export const zDeleteGlobalSettingData = z.object({
  body: z.never().optional(),
  path: z.object({
...
export const zGetGlobalSettingData = z.object({
  body: z.never().optional(),
  path: z.object({
    key: zGlobalSettingKey
  }),
