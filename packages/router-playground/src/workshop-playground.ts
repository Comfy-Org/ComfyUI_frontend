...
/** Labels for the fallback form; the site passes its translations. */
export interface FallbackFieldLabels {
...
export const ENGLISH_FALLBACK_LABELS: FallbackFieldLabels = {
  prompt: 'Prompt',
  promptPlaceholder: 'Describe what you want to make',
  seed: 'Seed',
...
function fallbackSchemasFor(
  labels: FallbackFieldLabels
...
export function schemaForModel(
  ...
  labels: FallbackFieldLabels = ENGLISH_FALLBACK_LABELS
  ...
  return model.fields.length
    ...
    : fallbackSchemasFor(labels)[model.modality ?? 'other']
}
