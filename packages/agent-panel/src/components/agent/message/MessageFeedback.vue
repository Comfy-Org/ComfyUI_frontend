...
<template>
  <div class="text-agent-fg-subtle flex items-center gap-1">
    <button
      type="button"
      ...
      :class="
        cn(
          'rounded-agent hover:bg-agent-surface-hover hover:text-agent-fg flex size-7 items-center justify-center transition-colors',
    ...
    <button
      ...
      class="rounded-agent hover:bg-agent-surface-hover hover:text-agent-fg flex size-7 items-center justify-center transition-colors"
      @click="copy(text)"
    >
      <span
        :class="
