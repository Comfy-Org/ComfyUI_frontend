...
const failureLabels: Record<z.infer<typeof failureSchema>, string> = {
  ...
  network: 'Connection interrupted; retry the unchanged request',
  response: 'Router responded but the result could not be read',
  client: 'Page request processing failed',
  conflict: 'Router could not return the existing request result',
