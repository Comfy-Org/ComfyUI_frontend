...
const translations = {
  ...
  'showcase.subtitle2': {
    ...
    ja: 'コミュニティテンプレートから始めるか、ゼロから構築するか。'
  },
  ...
  'useCase.body': {
    ...
    ja: `60,000以上のノード、数千のワークフロー、
そしてどんな企業よりも速く構築するコミュニティによって支えられています。`
  },
  'useCase.cta': {
...
Enterprise`
  ...
  'caseStudy.subheading': {
    ...
    ja: 'ComfyUIで構築するチームのビデオとケーススタディ'
  },
  'caseStudy.seeAll': {
...
export function t(key: TranslationKey, locale: Locale = 'en'): string {
  const entry = translations[key] as { en: string } & Partial<
    Record<Locale, string>
  >
