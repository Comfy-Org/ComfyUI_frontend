/**
 * The marketing copy content-of-record: every key, in every locale a person has
 * approved, plus the machine layer underneath it.
 *
 * This is the BUILD-TIME half of what used to be `translations.ts`. It holds all
 * locales at once, which is right for a build (one Node process renders every
 * language) and wrong for a browser (a visitor downloaded all of them). The
 * browser is served by `translations.ts`, which reads one pre-resolved
 * dictionary instead.
 *
 * Nothing here may use `import.meta.env` or `import.meta.glob`: the pipeline
 * scripts load this module under `tsx`, where `import.meta.env` is `undefined`
 * and `glob` does not exist.
 */
...
Enterprise`
  ...
  // Page meta, moved out of the .astro files by P3-3. Before this, each page
  // hardcoded its own title and description and its zh-CN twin hardcoded the
  // Chinese, so a third language meant a third hand-written file. Chinese here
  // is the translation a person already wrote: it is approved, and the
  // pipeline is not allowed to touch it.
  // 404.astro
  'notFound.meta.title': {
    en: '404 - Page Not Found - Comfy'
  },
  'notFound.a11y.pageLabel': {
  ...
  'about.meta.description': {
    en: 'Comfy builds ComfyUI, the open-source engine for visual AI, and the desktop, cloud, API, and enterprise products around it. Meet the team and the mission.',
    'zh-CN': '了解 ComfyUI 背后的团队和使命——开源的生成式 AI 平台。'
  },
  // booking-confirmation.astro
  'bookingConfirmation.meta.title': {
    en: "You're booked - Comfy",
    'zh-CN': '预约成功 - Comfy'
  },
  'bookingConfirmation.meta.description': {
    en: 'Your meeting is booked. Check your email for the calendar invite and meeting link.',
    'zh-CN': '您的会议已预约成功。请查收邮件中的日历邀请和会议链接。'
  },
  // careers.astro
  'careers.meta.title': {
    en: 'Careers - Comfy',
  ...
  'careers.meta.description': {
    en: 'Join the team building the operating system for generative AI. Open roles in engineering, design, marketing, and more.',
    'zh-CN':
      '加入构建生成式 AI 操作系统的团队。工程、设计、市场营销等岗位开放招聘中。'
  },
  // cloud/index.astro
  'cloud.meta.title': {
    en: 'Comfy Cloud - AI in the Cloud',
    'zh-CN': 'Comfy Cloud - 云端 AI'
  },
  // contact.astro
  'contact.meta.title': {
    en: 'Contact - Comfy',
  ...
  'contact.meta.description': {
    en: 'Reach Comfy about Enterprise, Forward Deployed Creatives, MiniMax commercial licenses, or partnerships. Common questions answered, including SOC 2 status.',
    'zh-CN':
      '就企业版、驻场创意人才、MiniMax 商业许可或合作事宜联系 Comfy。常见问题解答，包括 SOC 2 进展。'
  },
  // customers.astro
  ...
  // download.astro
  'download.meta.title': {
    en: 'Download Comfy Desktop - Run AI on Your Hardware',
    'zh-CN': '下载 Comfy 桌面版 - 在您的硬件上运行 AI'
  },
  ...
  'gallery.meta.description': {
    en: "Work built in ComfyUI by the community: images, video, and 3D. Submit your own to be featured on the site and Comfy's social channels.",
    'zh-CN':
      '社区在 ComfyUI 中创作的作品：图像、视频与 3D。提交你的作品，有机会在网站和 Comfy 社交渠道展示。'
  },
  // index.astro
  'home.meta.title': {
  ...
  'individualSubmission.meta.title': {
    en: 'Thanks for reaching out - Comfy',
    'zh-CN': '感谢您的联系 - Comfy'
  },
  'individualSubmission.meta.description': {
    en: 'Thanks for reaching out. Based on what you shared, one of our self-serve plans is probably a better fit.',
    'zh-CN':
      '感谢您的联系。根据您提供的信息，我们的自助服务套餐之一可能更适合您。'
  },
  'individualSubmission.cta.label': {
    en: 'See plans and pricing →',
    'zh-CN': '查看套餐与价格 →'
  },
  // models.astro
  'models.meta.title': {
  ...
  // pixal3d-trellis2.astro
  'pixal3dTrellis2.meta.title': {
    en: 'Pixal3D + TRELLIS.2 in ComfyUI'
  },
  'pixal3dTrellis2.meta.description': {
    en: 'Turn one image into a textured 3D model with Pixal3D and TRELLIS.2 in ComfyUI. Explore examples, download GLBs, and open the workflow.'
  },
  // platform/serverless-animation.astro
  'platform.serverlessAnimation.meta.title': {
    en: 'Serverless animation comparison · Comfy'
  },
  'platform.serverlessAnimation.meta.description': {
    en: 'Temporary side-by-side serverless animation study.'
  },
  // pricing.astro
  'pricing.meta.title': {
    en: 'Pricing - Comfy Cloud',
    'zh-CN': '定价 - Comfy Cloud'
  },
  'pricing.meta.description': {
    en: 'Comfy Cloud plans and credits: start free with 5 GPU runs, then pick Standard, Creator, Pro, or Team for monthly credits, hosted models, and longer workflow runtimes.',
    'zh-CN':
      'Comfy Cloud 套餐与积分：免费开始（5 次 GPU 运行），再选择 Standard、Creator、Pro 或 Team，获得每月积分、托管模型与更长的工作流运行时长。'
  },
  // privacy/desktop.astro
  'desktop_privacy.meta.title': {
    en: 'Desktop Privacy Policy - Comfy',
    'zh-CN': 'Desktop 隐私政策 - Comfy'
  },
  'desktop_privacy.meta.description': {
    en: 'Privacy policy for Comfy Desktop. Named processors, lawful basis under GDPR/UK GDPR, retention periods, and your rights.',
    'zh-CN':
      'Comfy Desktop 隐私政策。命名的数据处理方、GDPR/UK GDPR 下的合法依据、保留期限和您的权利。'
  },
  // privacy-policy.astro
  'privacy.meta.title': {
    en: 'Privacy Policy - Comfy',
    'zh-CN': '隐私政策 - Comfy'
  },
  'privacy.meta.description': {
    en: 'Comfy privacy policy. Learn how we collect, use, and protect your personal information.',
    'zh-CN': 'Comfy 隐私政策。了解我们如何收集、使用和保护您的个人信息。'
  },
  // terms-of-service.astro
  'tos.meta.title': {
    en: 'Terms of Service - Comfy'
  },
  ...
  // see it and no other language could reuse it. Approved, so never retranslated.
  // case-studies.astro
  'caseStudies.meta.title': {
    en: 'Case Studies - Comfy',
    'zh-CN': '案例研究 - Comfy'
  },
  // demos/index.astro
  'demos.meta.title': {
  ...
  'demos.meta.description': {
    en: 'Interactive demos and tutorials for ComfyUI.',
    'zh-CN': 'ComfyUI 的互动演示和教程。'
  },
  // videos.astro
  'videos.meta.title': {
    en: 'Videos - Comfy',
  ...
  // individual-submission.astro
  'individualSubmission.hero.title': {
    en: 'Thanks for reaching out.',
    'zh-CN': '感谢您的联系。'
  },
  'individualSubmission.plans': {
    en: 'Based on what you shared, one of our self-serve plans is probably a better fit. {standard}, {creator}, and {pro} for individual creators, plus our new {teams} plan for multiple users under shared billing.',
    'zh-CN':
      '根据您提供的信息，我们的自助服务套餐之一可能更适合您。面向个人创作者的 {standard}、{creator} 和 {pro}，以及我们全新的 {teams} 套餐，可让多位用户共享账单。'
  },
  'individualSubmission.enterpriseNeed': {
    en: "Still think you have an enterprise need?{break} We're happy to assist. Email: {email}",
    'zh-CN': '仍然认为您有企业级需求？我们很乐意为您提供帮助。邮箱：{email}'
  },
  'individualSubmission.otherHelp': {
    en: 'Need help with something else? Email: {email}',
    'zh-CN': '需要其他方面的帮助？邮箱：{email}'
  },
  // booking-confirmation.astro
  'bookingConfirmation.hero.title': {
    en: "You're booked.",
    'zh-CN': '预约成功。'
  },
  'bookingConfirmation.checkEmail': {
    en: 'Check your email for the calendar invite and meeting link!',
    'zh-CN': '请查收邮件中的日历邀请和会议链接！'
  },
  'bookingConfirmation.resources.heading': {
    en: 'Resources while you wait',
    'zh-CN': '等待期间的资源'
  },
  'bookingConfirmation.resources.learning': {
    en: 'Learning Center',
    'zh-CN': '学习中心'
  },
  'bookingConfirmation.resources.workflows': {
    en: 'Workflow templates',
    'zh-CN': '工作流模板'
  },
  'bookingConfirmation.resources.customers': {
    en: 'Customer stories',
    'zh-CN': '客户案例'
  },
  'bookingConfirmation.resources.docs': {
    en: 'Docs',
    'zh-CN': '文档'
  },
  // privacy-policy.astro
  ...
  // privacy/desktop.astro
  'desktop_privacy.hero.title': {
    en: 'Desktop Privacy Policy',
    'zh-CN': 'Desktop 隐私政策'
  },
  // search keywords, one comma-separated list per locale
  'home.meta.keywords': {
  ...
  'cloud.meta.keywords': {
    ...
    'zh-CN':
      'comfyui web app, comfyui app, comfyui online, comfyui cloud, ComfyUI 网页版, ComfyUI 云端, ComfyUI 应用, Comfy Cloud, 云端 ComfyUI'
  },
  'download.meta.keywords': {
    en: 'comfyui app, comfyui desktop app, comfyui desktop, comfy ui application, comfyui download, download comfyui, comfyui windows, comfyui mac, comfyui linux',
    'zh-CN':
      'comfyui app, comfyui desktop app, comfyui download, ComfyUI 下载, ComfyUI 桌面应用, ComfyUI 应用, ComfyUI Windows, ComfyUI macOS, ComfyUI Linux'
  },
  ...
  'workshop.form.rejected': {
    en: 'This value does not meet the model’s requirements',
    'zh-CN': '此值不符合模型的要求'
  },
  ...
  'workshop.output.cancelled': {
    en: 'Stopped waiting for the result. Check your balance before starting a new run.',
    'zh-CN': '已停止等待结果。开始新的运行前，请检查积分余额。'
  },
  'workshop.output.runAgain': { en: 'Run again', 'zh-CN': '再次运行' },
  'workshop.error.provider': {
    en: 'The result could not be retrieved. Retry the unchanged request to avoid submitting a new run.',
  ...
  'workshop.api.inputInvalid': {
    en: 'Complete valid model inputs in the Playground to generate a request.',
    'zh-CN': '请在试用区填写有效的模型参数以生成请求。'
  },
  'workshop.api.mappingUnavailable': {
    en: 'The native Router request mapping for this model has not been verified yet. Check the Router documentation before calling it.',
...
/**
 * English is the source and is always present; every translation is optional.
 *
 * `zh-CN` used to be required here, which is why Chinese reached 100% while
 * Japanese sat at 1%. It also meant a developer could not add English copy
 * without hand-writing Chinese, so the pipeline could never fill a Chinese gap:
 * there were none to fill.
 *
 * This matches the hub, where translations are plain JSON that may or may not
 * hold a key. Completeness is not a build requirement there either; it gates
 * INDEXING, per page, via `predicate.ts`. Marketing does the same through
 * `INDEXABLE_PAGES`: an untranslated page is held back rather than blocking
 * anyone's merge.
 */
