...
// One control for the whole prototype. V1 is the models catalogue laid out as a
// row per use case (11 Sep) and V2 is the screen where workflows, apps and
// models live together (GA 30 Sep), carrying its use cases in a rail. The two
// takes V1 beat, the categories in a rail beside the grid and the tabs the
