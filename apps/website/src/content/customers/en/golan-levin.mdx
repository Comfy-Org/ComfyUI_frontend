...
*Try it yourself: [json file](https://github.com/golanlevin/60-212/blob/main/lectures/comfy/image_synthesis/workflows/p5-in-comfy.json) (Comfy Local only)*
...
*Workflow files: download the [.json](https://github.com/golanlevin/60-212/blob/main/lectures/comfy/image_analysis/workflows/3_image_depth_and_segmentation_for_comfycloud_2026.json), or the [.png with the workflow embedded in its metadata](https://raw.githubusercontent.com/golanlevin/60-212/main/lectures/comfy/image_analysis/workflows/3_image_depth_and_segmentation_for_comfycloud_2026.png) (drag it into ComfyUI to load the graph).*
