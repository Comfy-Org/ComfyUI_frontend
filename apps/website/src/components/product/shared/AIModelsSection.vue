...
const cardClass =
  'group relative h-72 cursor-pointer rounded-4xl bg-white/8 p-2 lg:col-span-4 lg:aspect-square lg:h-auto'
</script>
  ...
  >
    <div class="mx-auto flex w-full max-w-7xl flex-col items-center">
      ...
      <div class="mt-16 w-full lg:mt-24">
        <div class="rounded-4xl p-2 lg:p-1.5">
          <div class="grid grid-cols-1 gap-2 lg:grid-cols-12">
            ...
            >
              <div
                class="relative size-full overflow-hidden rounded-3xl bg-black/40"
              >
                <video
