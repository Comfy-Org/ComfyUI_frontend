...
| File                                                                                                                                                    | Role                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| [`pages/cloud/supported-nodes.astro`](../../pages/cloud/supported-nodes.astro) and [`[pack].astro`](../../pages/cloud/supported-nodes/%5Bpack%5D.astro) | Page shells (and `zh-CN` twins)                                         |
