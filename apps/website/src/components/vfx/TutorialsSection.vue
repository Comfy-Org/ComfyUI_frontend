...
import { getTutorialPosterSrc, vfxTutorials } from '../../data/vfxTutorials'
...
<template>
  <section class="max-w-9xl mx-auto px-6 py-16 lg:py-24">
    ...
    >
      <li
        v-for="tutorial in vfxTutorials"
        :key="tutorial.id"
      ...
      >
        <button
          ...
          :aria-label="`${t('vfx.tutorials.titlePrefix', locale)} ${tutorial.title[locale]}`"
        ...
        <div class="flex flex-col space-y-3 p-4">
          <div class="flex items-center justify-between gap-4">
            ...
            >
              {{ t('vfx.tutorials.titlePrefix', locale) }}<br />
