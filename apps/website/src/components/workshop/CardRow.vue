...
const arrowClass = (disabled: boolean) =>
  cn(
    'focus-visible:ring-primary-comfy-yellow/50 bg-page/80 grid size-9 place-items-center rounded-full border border-transparency-white-t20 text-primary-warm-white backdrop-blur-sm transition-opacity outline-none focus-visible:ring-3',
    disabled
...
<template>
  <div class="relative">
    ...
    <div
      v-if="!atEnd"
      class="from-page pointer-events-none absolute inset-y-0 right-0 w-24 bg-linear-to-l to-transparent"
      aria-hidden="true"
    />
