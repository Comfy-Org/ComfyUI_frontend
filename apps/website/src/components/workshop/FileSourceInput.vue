...
<template>
  <div
    ...
    :class="
      cn(
        'flex min-w-0 flex-col gap-3 rounded-2xl border border-dashed focus-within:ring-2 focus-within:ring-primary-comfy-yellow',
        dropZoneActive
  ...
  >
    ...
    <label
      ...
      :class="
        cn(
          'flex min-h-20 cursor-pointer flex-col items-center justify-center gap-1 rounded-2xl text-xs text-primary-warm-gray hover:bg-transparency-white-t4',
