      ...
      >
        <DropdownMenuSub v-model:open="workspacesOpen">
          <DropdownMenuSubTrigger
            ...
            class="flex w-full cursor-pointer items-center gap-3 rounded-xl p-2 text-left outline-none hover:bg-transparency-white-t4 focus-visible:bg-transparency-white-t4 data-[state=open]:bg-transparency-white-t4"
          >
            <span
