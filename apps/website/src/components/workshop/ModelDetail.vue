  ...
  <div class="flex flex-col gap-10" data-testid="model-detail">
    ...
    >
      ...
      <a
        ...
        class="ml-auto inline-flex shrink-0 items-center gap-1.5 pb-3 text-sm font-bold tracking-wider whitespace-nowrap text-primary-warm-white uppercase transition-colors hover:text-primary-comfy-yellow"
