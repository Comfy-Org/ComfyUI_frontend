...
import CinematicModelDurationSummary from './CinematicModelDurationSummary.vue'
import CinematicModelCapabilityDetails from './CinematicModelCapabilityDetails.vue'
        ...
        <ul class="space-y-2">
          ...
          >
            <div class="min-w-0 flex-1">
              ...
              <CinematicModelDurationSummary
                v-if="entry.modality === 'video'"
                :capabilities="entry.capabilities"
                :locale
              />
              <CinematicModelCapabilityDetails
                :entry
                :timing="timings[entry.slug]"
                :locale
              />
            </div>
            <Button
