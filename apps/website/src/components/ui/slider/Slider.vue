...
<template>
  ...
  >
    ...
    <SliderThumb
      ...
      class="block size-4 shrink-0 rounded-full border border-primary-comfy-yellow bg-primary-warm-white shadow-sm ring-primary-comfy-yellow/50 transition-[color,box-shadow] hover:ring-4 focus-visible:ring-4 focus-visible:outline-hidden disabled:pointer-events-none disabled:opacity-50"
    />
  </SliderRoot>
