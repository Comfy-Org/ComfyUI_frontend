  ...
  ],
  {
    variants: {
      ...
      variant: {
        ...
        inline:
          'text-primary-comfy-yellow inline h-auto rounded-none p-0 align-baseline text-sm font-normal tracking-normal whitespace-normal underline hover:opacity-90',
