  ...
  ],
  {
    variants: {
      ...
      variant: {
        ...
        nav: 'text-nav-fg-strong hover:text-nav-accent h-auto justify-between px-0 py-1 text-start text-2xl font-medium',
        navMuted:
          'hover:text-nav-accent h-auto w-full justify-between px-0 py-1 text-start text-2xl font-medium text-nav-fg uppercase'
      }
    },
    defaultVariants: {
      variant: 'default',
