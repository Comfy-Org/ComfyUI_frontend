...
<template>
  <DialogPortal>
    ...
    >
      ...
      <SheetClose
        class="absolute top-4 right-4 rounded-xl border border-primary-comfy-yellow p-2 text-primary-comfy-yellow ring-offset-primary-comfy-ink transition-opacity focus:ring-2 focus:ring-primary-comfy-yellow/50 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none"
      >
        <X class="size-6" />
