...
export const navigationMenuTriggerStyle = cva([
  'group inline-flex cursor-pointer items-center justify-center gap-1.5 rounded-2xl p-3 font-formula text-sm font-extrabold tracking-wider text-primary-comfy-canvas uppercase transition-[color,box-shadow] outline-none 2xl:px-4',
