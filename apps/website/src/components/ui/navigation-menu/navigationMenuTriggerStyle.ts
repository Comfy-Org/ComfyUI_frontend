...
export const navigationMenuTriggerStyle = cva([
  'group inline-flex cursor-pointer items-center justify-center gap-1.5 rounded-2xl px-4 py-3 font-formula text-sm font-extrabold tracking-wider text-primary-comfy-canvas uppercase transition-[color,box-shadow] outline-none',
