  ...
  >
    ...
    >
      <span v-if="modelValue === category.value" class="relative inline-block">
        <span
          class="inline-block items-center rounded-lg bg-primary-comfy-yellow px-4 py-2"
        >
          {{ category.label }}
        </span>
        <!-- Triangle pointer -->
      ...
      <span
        v-else
        class="inline-block items-center rounded-lg bg-transparency-white-t4 px-4 py-2"
      >
        {{ category.label }}
      </span>
    </button>
