...
// is the ordinary case and says nothing; a card only speaks up for the few
// that ask for an install, because a mark on every card marks nothing.
const { reach, locale = 'en' } = defineProps<{
