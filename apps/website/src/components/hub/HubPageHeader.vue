...
// own tabs below the fold.
const summaryId = useId()
const summaryEl = useTemplateRef<HTMLParagraphElement>('summaryEl')
  ...
  <header class="mb-12" data-testid="hub-page-header">
    ...
    >
      <div class="flex max-w-2xl flex-col gap-4">
        ...
        <div v-if="summary" class="flex flex-col items-start gap-1">
          <p
            :id="summaryId"
            ref="summaryEl"
            :class="
