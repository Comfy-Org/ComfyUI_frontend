...
<template>
  <div ref="root" role="img" :aria-label="label">
    <pre
      aria-hidden="true"
      class="scrollbar-none h-[calc(var(--panel-h)*0.9)] overflow-auto rounded-3xl bg-[#2a2230] p-4 font-mono text-2xs/relaxed whitespace-pre-wrap text-primary-comfy-canvas select-none sm:p-5 sm:text-xs/relaxed sm:whitespace-pre lg:h-(--panel-h) lg:p-6 lg:text-sm/relaxed"
