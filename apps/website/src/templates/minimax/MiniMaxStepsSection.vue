...
import { minimaxSteps } from '../../data/minimax'
    ...
    <ol class="mt-10 grid grid-cols-1 gap-4 md:grid-cols-3">
      ...
      >
        ...
        <div class="flex flex-col gap-8 p-5">
          ...
          >
            {{ t('minimax.steps.step', locale) }} {{ stepNumber(index) }}
          </p>
