...
const pages: { name: string; page: ModelLaunchPage }[] = [
  ...
  // chatgptImage25 is intentionally excluded: its gallery cards use local
  // placeholder images (real stills aren't available yet), which this
  // suite's media-url checks correctly reject as non-CDN.
]
