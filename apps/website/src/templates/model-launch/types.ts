...
export interface ModelLaunchHero {
  ...
  // Overlay pages only: spins the extruded Comfy C in the media cell and
  // shows this image through its body, with placeholderImageSrc as the
  // reduced-motion and pre-WebGL still.
