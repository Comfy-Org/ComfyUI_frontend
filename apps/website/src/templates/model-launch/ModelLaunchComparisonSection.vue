...
<template>
  <section class="mx-auto max-w-9xl px-6 py-16 lg:px-20 lg:py-24">
    ...
    <div class="mt-12 rounded-5xl bg-transparency-white-t4 p-4 lg:p-2">
      <div class="overflow-x-auto rounded-4.5xl bg-primary-comfy-ink">
        <table class="w-full min-w-xl border-collapse text-left">
          <thead>
            <tr>
              ...
              <th
                ...
                :key="column.id"
                scope="col"
                class="p-6 text-sm/tight font-extrabold tracking-wider text-primary-comfy-yellow uppercase"
              >
          ...
          <tbody>
            <tr
              ...
              :key="row.id"
              class="border-t border-transparency-white-t4"
            >
              <th
                scope="row"
