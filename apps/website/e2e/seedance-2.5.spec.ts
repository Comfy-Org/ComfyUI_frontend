...
const HERO_TITLE = t('seedance25.hero.title', 'en')
const HERO_CTA = t('seedance25.hero.primaryCta', 'en')
const RUN_OPTIONS_HEADING = t('seedance25.runOptions.heading', 'en')
...
test.describe('Seedance 2.5 announcement page @smoke', () => {
  ...
  test('omits the sections the model cannot back yet', async ({ page }) => {
    ...
    // No gallery, pricing or FAQ until Seedance 2.5 ships.
